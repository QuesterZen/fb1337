...
from fb1337.array import Array, Coordinate
from fb1337.dictionary import Dictionary
from fb1337.iterators import Iterator, ListIterator, LoopIterator, Slice
from fb1337.lambda_fn import Lambda, run_object, fp2fn
from fb1337.matrix import Matrix
...
FBLeet_language = [
	...
	{'symbol': '∧', 'signature': (2, 0, 0, 0), 'alias': 'and', 'group': 'math', 'patterns': [
		...
		{'signature': ('int', 'int'), 'description': 'logical and', 'function': lambda e, a, b:
		a and b},
	...
	{'symbol': '⟘', 'signature': (2, 0, 0, 0), 'alias': 'binary', 'group': 'math', 'patterns': [
		{'signature': ('int', 'int'), 'description': 'binary value as list of length n',
		 'function': lambda e, x, n: ListIterator(([0] * n + [int(ch) for ch in bin(x)[2:]])[-n:])},
	]},
	...
	{'symbol': '¦', 'signature': (1, 0, 0, 0), 'alias': 'decode', 'group': 'string', 'patterns': [
		...
		{'signature': ('int',), 'description': 'convert an ascii code point to a string character',
		 'function': lambda e, l: ListIterator([l]).stringify(True)},
	]},
	...
	{'symbol': '‿', 'signature': (1, 1, 0, 0), 'alias': 'pair', 'group': 'list', 'patterns': [
		...
		{'signature': ('any', 'any'), 'description': 'pair two values into a list',
		 'function': lambda e, a, b: ListIterator.pair(a, b)},
	]},
	...
	{'symbol': '⏍', 'signature': (0, 0, 0, 0), 'alias': 'gather', 'group': 'list', 'patterns': [
		{'signature': (), 'description': 'put all values on the stack stack (from last null) into a list',
		 'function': lambda e: ListIterator.stack_to_list(e)},
	]},
	{'symbol': '☐', 'signature': (0, 1, 0, 0), 'alias': 'gather n', 'group': 'list', 'patterns': [
		{'signature': ('int',), 'description': 'put the top n items on the stack into a list',
		 'function': lambda e, n: ListIterator([e.pop() for _ in range(n)][::-1])},
	]},
	{'symbol': '☆', 'signature': (1, 0, 0, 0), 'alias': 'scatter', 'group': 'list', 'patterns': [
		{'signature': ('Array',), 'description': 'put each item in the list onto the stack',
		 'function': lambda e, l: [[e.push(x) for x in l.flat_list()], None][1]},
	...
	{'symbol': '⊟', 'signature': (1, 0, 0, 0), 'alias': 'enlist', 'group': 'list', 'patterns': [
		{'signature': ('Coordinate',), 'description': 'wrap a coordinate into a list',
		 'function': lambda e, a: ListIterator([a])},
		{'signature': ('Array',), 'description': 'convert a structured array into a flat list',
		 'function': lambda e, a: ListIterator(a.all_values())},
		{'signature': ('int',), 'description': 'wrap a value into a list',
		 'function': lambda e, x: ListIterator([int(x)])},
		{'signature': ('any',), 'description': 'wrap a value into a list', 'function': lambda e, x: ListIterator([x])},
	]},
	{'symbol': '⍳', 'signature': (1, 0, 0, 0), 'alias': 'iota', 'group': 'list', 'patterns': [
		{'signature': ('int',), 'description': 'list of integer values from 1 to n',
		 'function': lambda e, t: ListIterator.int_list(t)},
	]},
	{'symbol': '‥', 'signature': (2, 0, 0, 0), 'alias': 'range', 'group': 'list', 'patterns': [
		{'signature': ('int', 'int'), 'description': 'list of integer values in the range m to n',
		 'function': lambda e, m, n: ListIterator.int_list(m, n)},
	]},
	...
	{'symbol': '@', 'signature': (1, 2, 0, 0), 'alias': 'replace', 'group': 'list', 'patterns': [
		{'signature': ('List', 'int', 'any'), 'description': 'replace the value at an index in a list',
		 'function': lambda e, l, i, v: l.set_location(i, v)},
		{'signature': ('List', 'Slice', 'any'), 'description': 'replace values in a list given by slice',
		 'function': lambda e, l, s, v: l.set_slice(s, v)},
		{'signature': ('Array', 'Array', 'any'), 'description': 'replace all values at the given indices',
		 'function': lambda e, l, a, v: l.set_indices(a, v)},
		{'signature': ('Array', 'int', 'any'), 'description': 'replace the value at an index in a list',
		 'function': lambda e, l, i, v: l.set_index(i, v)},
	...
	{'symbol': '[', 'signature': (1, 3, 0, 0), 'alias': 'slice', 'group': 'list', 'patterns': [
		{'signature': ('List', 'any', 'any', 'any'),
		 'description': 'create a new list by taking a slice from the list [start : stop : step]',
		 'function': lambda e, l, s, f, a: l.slice(Slice(s, f, a))},
		{'signature': ('str', 'any', 'any', 'any'),
		 'description': 'create a new string by taking a slice from the string [start : stop : step]',
		 'function': lambda e, l, s, f, a: Slice(s, f, a).slice_string(l)},
	]},
	{'symbol': '{', 'signature': (0, 3, 0, 0), 'alias': 'make slice', 'group': 'list', 'patterns': [
		{'signature': ('any', 'any', 'any'), 'description': 'create a slice object [start : stop : step]',
		 'function': lambda e, s, f, a: Slice(s, f, a)},
	]},

	# List Pointer Movement

	{'symbol': '◇', 'signature': (1, 0, 0, 0), 'alias': 'current', 'group': 'list', 'patterns': [
		{'signature': ('List',), 'description': 'returns the current value',
		 'function': lambda e, l: l.values[l.index]},
	]},
	{'symbol': '⇤', 'signature': (1, 0, 0, 0), 'alias': 'first', 'group': 'list', 'patterns': [
		{'signature': ('List',), 'description': 'moves the list pointer to the first non-null value',
		 'function': lambda e, l: [l.move_to(0), l][1]},
		{'signature': ('str',), 'description': 'returns the first character of string',
		 'function': lambda e, s: s[0]},
	]},
	{'symbol': '⇥', 'signature': (1, 0, 0, 0), 'alias': 'last', 'group': 'list', 'patterns': [
		{'signature': ('List',), 'description': 'moves the list pointer to the end of the list',
		 'function': lambda e, l: [l.move_to(-1), l][1]},
		{'signature': ('str',), 'description': 'returns the last character of string',
		 'function': lambda e, s: s[-1]},
	]},
	{'symbol': '⪼', 'signature': (1, 0, 0, 0), 'alias': 'next', 'group': 'list', 'patterns': [
		{'signature': ('List',), 'description': 'moves the list pointer to the next non-null value',
		 'function': lambda e, l: [l.next(1), l][1]},
	]},
	{'symbol': '⪻', 'signature': (1, 0, 0, 0), 'alias': 'prev', 'group': 'list', 'patterns': [
		{'signature': ('List',), 'description': 'moves the list pointer to previous non-null value',
		 'function': lambda e, l: [l.next(-1), l][1]},
	]},
	{'symbol': '≻', 'signature': (2, 0, 0, 0), 'alias': 'move', 'group': 'list', 'patterns': [
		{'signature': ('List', 'int'), 'description': 'moves the list pointer to a specified index',
		 'function': lambda e, l, i: [l.move_to(i), l][1]},
	]},
	...
	{'symbol': '⌸', 'signature': (0, 0, 0, 0), 'alias': 'stack2mat', 'group': 'matrix', 'patterns': [
		{'signature': (), 'description': 'convert values on the stack (from the last null) to a matrix',
		 'function': lambda e: convert_collection(ListIterator.stack_to_list(e).values, 'Matrix')},
	]},
	...
	{'symbol': 'ℰ', 'signature': (1, 0, 0, 0), 'alias': 'diagonalize', 'group': 'matrix', 'patterns': [
		{'signature': ('Matrix',),
		 'description': 'return an n x n diagonal eigenvalue matrix and an n x n eigenvector matrix',
		 'function': lambda e, m: [e.push(i) for i in m.eigen_matrices()] and None},
	]},
	...
	{'symbol': '¢', 'signature': (1, 0, 0, 0), 'alias': 'coordinate', 'group': 'coordinate', 'patterns': [
		{'signature': ('Array',), 'description': 'create a coordinate using values from a list',
		 'function': lambda e, l: Array.coordinate(l)},
	]},
	...
	{'symbol': '#', 'signature': (1, 0, 0, 0), 'alias': 'count', 'group': 'array', 'patterns': [
		...
		{'signature': ('List',), 'description': 'the length of a flat list',
		 'function': lambda e, l: len(l.flat_list())},
	...
	{'symbol': '⤲', 'signature': (2, 0, 0, 0), 'alias': 'split', 'group': 'array', 'patterns': [
		{'signature': ('str', 'str'), 'description': 'split a string using characters from the second string',
		 'function': lambda e, a, b: ListIterator(str(a).split(str(b)))},
	...
	{'symbol': '⊇', 'signature': (2, 0, 0, 0), 'alias': 'select', 'group': 'array', 'patterns': [
		...
		{'signature': ('Dictionary', 'List'), 'description': 'fetch values from a dictionary using a list of keys',
		 'function': lambda e, d, l: ListIterator([d.fetch(i) for i in l.values])},
	...
	{'symbol': '⋸', 'signature': (2, 0, 0, 0), 'alias': 'find all', 'group': 'array', 'patterns': [
		...
		{'signature': ('str', 'str'),
		 ...
		 'function': lambda e, s1, s2: ListIterator([i for i, ch in enumerate(s1) if ch in s2])},
		{'signature': ('Array', 'any'),
	...
	{'symbol': '∊', 'signature': (2, 0, 0, 0), 'alias': 'find all?', 'group': 'array', 'patterns': [
		...
		{'signature': ('str', 'str'),
		 ...
		 'function': lambda e, s1, s2: ListIterator([ch in s2 for ch in s1])},
		{'signature': ('Array', 'any'),
	...
	{'symbol': '⎅', 'signature': (1, 0, 0, 0), 'alias': 'reflect', 'group': 'structured array', 'patterns': [
		{'signature': ('List',), 'description': 'reverse a list',
		...
		{'signature': ('Array',), 'description': 'reverse a structured array on its last axis (reverse each row)',
		 'function': lambda e, l: l.reverse_on_axis(-1)},
		{'signature': ('str',), 'description': 'reverse a string', 'function': lambda e, x: str(x)[::-1]},
	]},
	...
	{'symbol': 'Ω', 'signature': (0, 3, 0, 0), 'alias': 'for', 'group': 'iteration', 'patterns': [
		{'signature': ('any', 'any', 'any'),
		 ...
		 'function': lambda e, s, f, a: Iterator(s, f, a)},
	]},
	{'symbol': ':', 'signature': (1, 0, 0, 1), 'alias': 'iterate', 'group': 'iteration', 'patterns': [
		...
		{'signature': ('Array', 'block'), 'description': 'iterate through the values of an array',
		 'function': lambda e, l, b: ListIterator(l.structured_values()).start(e, b)},
		{'signature': ('Slice', 'block'), 'description': 'iterate over a slice range',
		 'function': lambda e, s, b: s.start(e, b)},
		{'signature': ('int', 'block'), 'description': 'iterate over the values 1 to n',
		 'function': lambda e, t, b: LoopIterator(t, 1).start(e, b)},
		{'signature': ('str', 'block'), 'description': 'iterate over the characters in a string',
		 'function': lambda e, t, b: ListIterator.to_ch_list(t).start(e, b)},
	]},
	...
	{'symbol': '∮', 'signature': (0, 0, 0, 0), 'alias': 'load list', 'group': 'files', 'patterns': [
		{'signature': (), 'description': 'create a list with values from a file',
		 'function': lambda e: ListIterator(e.file_in(ints=True, cols=False))},
	]},
...
class Commands:
	...
	def __init__(self, command_list=FBLeet_language):
