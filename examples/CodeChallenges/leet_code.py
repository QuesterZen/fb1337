...
leet_code_solutions = [
    ...
    {'name': 'challenge 3.1', 'code': "➋➊¨⟜0⊇'=", 'parameters': [['alice', 'bob', 'charlie'], 'abc'], 'result': 1},
    {'name': 'challenge 3.2', 'code': "➋➊¨⟜0⊇'=", 'parameters': [['an', 'apple'], 'a'], 'result': 0},
    ...
    {'name': 'challenge 7a.1', 'code': "➊𝒮𝚿-𝚽⊚+/+⌿+¬", 'parameters': [[[0, 1, 1], [1, 0, 1], [0, 0, 1]]],
     'result': [[0, 0, 4], [0, 0, 4], [-2, -2, 2]]},
    {'name': 'challenge 8.1', 'code': "➊∂}‰2𝒮⊕⟈", 'parameters': [[3, 1, 2, 4]], 'result': [2, 4, 3, 1]},
    {'name': 'challenge 8a.1', 'code': "➊∂}‰2∂®«⟈⊕", 'parameters': [[3, 1, 2, 4]], 'result': [2, 4, 3, 1]},
    ...
    {'name': 'challenge 10.2', 'code': "0➊:_1⊇`+=?⩓⩔",
     'parameters': [
         ['X++', '--X', '++X', '++X', 'X--', 'X++', '--X', '++X', '++X', '--X', 'X++', '--X', '++X', '++X', '--X',
          'X--', 'X++', '++X', '--X']],
     'result': 3},
    {'name': 'challenge 10.3', 'code': "0➊:_1⊇`+=?⩓⩔", 'parameters': [[]], 'result': 0},
    ...
    {'name': 'challenge 41.1', 'code':
        "µ$1⎅0⊇ $1¨µḋ⊢‿⊢¢)⍮◌)→build                              ⍝ build the initial coordinate list ()->list\n"
        "µ⇶1 ⇴1,0⊇ ⇴1↓1)→pop                                      ⍝ pop the first value off the list (list)->val,list\n"
        "µ⇶1 ⇴1☆ $1«⋸⩔$1«⊇ ☐2¢)→gen                               ⍝ generate the next fraction (frac)->frac\n"
        "µ⇶2 ⇴1,0⊇⇴2,1⊇× ⇴1,1⊇⇴2,0⊇× <)→lt                            ⍝ frac1 < frac2 (frac1, frac2)->bool\n"
        "µ⇶2 ⇴1∂#→l 1‿~1 0$l⍴ ⇴2⩔…↦ $l⍳1-+ ⊇)→swap               ⍝ swap adjacent values (list, 2nd pos)->list\n"
        "µ⇶2 ⇴1⇴2⁔ ⇴1#⩔~: ∂∂_⊇« _⩔⊇ £lt ? µ_£swap) ⌁;)→insert    ⍝ insert a value into an ordered list (list, frac)->list\n"
        "0 £build $2: ⍮◌ £pop ḋ« £gen £insert; ◌",
